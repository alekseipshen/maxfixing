          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="text-gray-700 space-y-4">
              <p className="text-base md:text-lg leading-relaxed">
                ...
                repairs for restaurants, hotels, and businesses across Los Angeles & Orange County. Our factory-trained technicians 
                understand that downtime costs you money.
              </p>
              
              <p className="text-base md:text-lg leading-relaxed">
                <strong>Max Fixing</strong> provides <strong>same-day commercial repair</strong> for 
                all major brands. Upfront pricing, solid warranty, and 20+ years of experience keeping Los Angeles & Orange County 
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                Decades of experience repairing commercial equipment for Los Angeles & Orange County businesses.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <div className="flex justify-center mb-4">
