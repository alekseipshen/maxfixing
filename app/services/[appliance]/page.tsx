...
export default async function ApplianceRepairPage({ params }: PageProps) {
  ...
  return (
    <>
      ...
      <ReviewPhotosSection appliance={cleanSlug} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                Over two decades repairing Los Angeles & Orange County kitchen and laundry appliances. Factory-trained, certified technicians.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <div className="flex justify-center mb-4">
