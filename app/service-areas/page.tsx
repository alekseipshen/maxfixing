        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              We Serve {cities.length} Cities Across LA & Orange County
            </h1>
            <p className="text-xl md:text-2xl text-green-100 mb-8">
              Same-day appliance repair service available in Los Angeles and Orange County areas
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">
              Professional Appliance Repair Throughout Los Angeles & Orange County
            </h2>
            <div className="text-gray-700 space-y-4">
              <p className="text-base md:text-lg leading-relaxed">
                For over 20 years, <strong>Max Fixing</strong> has been the trusted choice for appliance
                repair across Southern California. Our factory-trained technicians provide same-day service to homes and businesses
                in San Fernando Valley, West Los Angeles, San Gabriel Valley, South Bay, and Orange County.
              </p>
              <p className="text-base md:text-lg leading-relaxed">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Serving 5 regions across Los Angeles and Orange County
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 max-w-6xl mx-auto mb-8">
            {counties.map((county) => {
              ...
              return (
                <a
                  key={county.slug}
                  href={`#${county.slug}`}
                  className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition border-2 border-transparent hover:border-green-600"
                >
          ...
          <div className="space-y-12 max-w-7xl mx-auto">
            {counties.map((county) => {
              ...
              return (
                ...
                >
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6 pb-4 border-b-2 border-green-600">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
                    {countyCities.map((city) => (
                      <Link
                        ...
                        prefetch={false}
                        className="bg-white p-3 rounded-lg hover:bg-green-50 hover:shadow-md transition text-center border border-gray-200 cursor-pointer"
                      >
