...
export default async function BrandApplianceRepairPage({ params }: PageProps) {
  ...
  return (
    <>
      ...
      <Hero
        title={`Same-Day ${brand.name} ${appliance.name} Repair in Los Angeles & Orange County`}
      ...
      <ReviewPhotosSection appliance={cleanApplianceSlug} brand={cleanBrandSlug} />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">Trusted by thousands of Los Angeles & Orange County homeowners</p>
            </div>
          </div>
        </div>
      </section>
