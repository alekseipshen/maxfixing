...
export function LocalBusinessSchema({ name, city, county, service }: LocalBusinessProps = {}) {
  ...
  const schema = {
    ...
    logo: 'https://maxfixing.com/logo.png',
    image: 'https://maxfixing.com/og-image.jpg',
    telephone: PHONE_NUMBER,
    email: BUSINESS_EMAIL,
    priceRange: '$$',
    address: {
      '@type': 'PostalAddress',
      addressLocality: city || 'Los Angeles',
      addressRegion: 'CA',
      addressCountry: 'US',
    },
...
export function ServiceSchema({ name, description, url, city, brand }: ServiceProps) {
  const areaServed = city ? `${city}, California` : 'Los Angeles & Orange County, California';
