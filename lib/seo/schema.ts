...
function generateBusinessDescription(params: SchemaParams): string {
  ...
  if (city && brand && appliance) {
    return `Professional ${formatBrandName(brand)} ${formatApplianceName(appliance)} repair in ${formatCityName(city)}, California. Same-day service, certified technicians.`;
  } else if (city && appliance) {
    return `Expert ${formatApplianceName(appliance)} repair in ${formatCityName(city)}, California. 20+ years experience, same-day service available.`;
  } else if (city) {
    return `Professional appliance repair services in ${formatCityName(city)}, California. All major brands and appliances. Same-day service.`;
  } else {
    return `Expert appliance repair across Los Angeles and Orange County. 20+ years experience, certified technicians, same-day service for all major brands.`;
  }
}
...
function generateServiceDescription(params: SchemaParams): string {
  ...
  if (city && brand && appliance) {
    return `Professional ${formatBrandName(brand)} ${formatApplianceName(appliance)} repair services in ${formatCityName(city)}, California. Factory-trained technicians, same-day service, upfront pricing.`;
  } else if (city && appliance) {
    return `Expert ${formatApplianceName(appliance)} repair in ${formatCityName(city)}, California. Certified technicians, same-day service, all major brands.`;
  } else if (brand && appliance) {
    return `Professional ${formatBrandName(brand)} ${formatApplianceName(appliance)} repair across Los Angeles and Orange County. Factory-trained technicians, 20+ years experience.`;
  } else {
    return `Professional appliance repair services across Los Angeles and Orange County. All major brands and appliances. Same-day service available.`;
  }
}
